class upload{
    ...
    this.filename="file";
    this.selectBtnStyle="width:100px;height:30px;border-radius:5px;background:orange;";
    this.selectBtnCon="请选择";
    this.upBtnStyle="width:100px;height:30px;border-radius:5px;background:#ccc;";
    this.upBtnCon="点击上传";
    this.pStyle="width:400px;border:1px solid red;overflow:hidden;";
    ...
    this.errorStyle="width:100%;height:30px;position:absolute;left:0;top:0;right:0;bottom:0;margin:auto;" +
        "text-align:center;line-height:30px;color:red;background:rgba(0,0,0,0.8)";
    this.errorCon="错误";
  ...
  * */
  ...
  // 开始选择文件
    ...
    createList(data){
        ...
        del.style.cssText="width:20px;height:20px;position:absolute;right:5px;top:5px;text-align:center;" +
            "line-height:20px;cursor:pointer;border:1px solid #777;display:none";
        del.innerHTML="X";
 ...
 createSelect(parent,selectBtn,callback){
     ...
     file.style.cssText="opacity:0;position:absolute;z-index:1;" +
